...
def subscription(qinq: mapping.SiteIndex) -> mapping.SubscriptionIdGuid:
    subscription_: mapping.SubscriptionId = qinq.subscriptions[0]
...
ATTRIBUTE = (mapping.subscription.nasport,)
...
@allure.title("QinQ. Тест атрибута подключки")
...
def test_attribute(
    ...
    if attribute.is_sync:
        ...
        allure.dynamic.title(
            f"QinQ. Тест атрибута подключки '{attribute.description}'"
        )
