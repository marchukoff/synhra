...
def subscription(mobile: mapping.SiteIndex) -> mapping.SubscriptionIdGuid:
    subscription_: mapping.SubscriptionId = mobile.subscriptions[0]
...
ATTRIBUTE = (mapping.subscription.msisdn, mapping.subscription.imsi)
...
@allure.title("Mobile. Тест атрибута подключки")
...
def test_attribute(
    ...
    if attribute.is_sync:
        ...
        allure.dynamic.title(
            f"Mobile. Тест атрибута подключки '{attribute.description}'"
        )
